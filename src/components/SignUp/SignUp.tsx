  ...
  return (
    <div>
      <button
        ...
        className="text-xl pb-3 bg-[#00ADEE] text-white  hidden md:block rounded-full  hover:bg-opacity-90 ease-in-out duration-150  pt-2  font-semibold text-center border-2 border-[#00ADEE] w-[120px] h-[50px]"
      >
        دخول
      </button>
      <Dialog open={open} onClose={handleClose} className="h-[727.31px] ">
          ...
          <div className="w-[400px]">
            <form onSubmit={handleSubmit} className=" w-full ">
              <div className="flex flex-col justify-center items-center ">
                ...
                <div className="w-[95%]">
                  <label className="font-semibold block mb-1">رقم الجوال</label>
                  <TextField
